...
|---|:---:|---|
| `flux_bootstrap_mode` | No | `github` or `readonly-public`; default: `github` |
...
| `flux_public_sync_path` | `readonly-public` | Public profile path, default: `infra-cluster/profiles/single-node/flux-bootstrap` |
