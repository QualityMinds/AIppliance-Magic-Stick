...
**dynamic GPU memory ceiling** using sliders in **System → Hardware → GPU memory → Shared
...
The normal user entrypoint is now **System → Hardware → GPU setup → Host preparation** for
