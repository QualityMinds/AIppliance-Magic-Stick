...
[GPU compatibility](../reference/gpu-compatibility.md) before enabling experiments. CPU and
...
change or reboot. See [host management](../administration/host-management.md) for experiments on
...
[first-run-setup.md](../installation/first-run-setup.md) for the complete flow.
...
Continue with [operations.md](../administration/troubleshooting/overview.md) for runtime checks.
