...
"""Core instance sharing with live identity checks and fail-closed ACLs."""
import copy
import importlib
import json
import re
...
def plugin():
    try:
        return importlib.import_module("magicstick_core.sharing")
...
class InstanceAccess:
    def __init__(self, *, user, groups, roles, identity, admin, request, namespace):
        self.user = user
        self.groups = groups
        self.roles = roles
