...
describe('targeted instance sharing', () => {
  ...
  it('blocks updates until the security guard is ready without loading the directory', async () => {
    vi.mocked(api.instanceAccess).mockResolvedValue({...state, sharing: {mode: 'selected', users: ['user-id'], groups: []}, guardReady: false});
